...
-   <span class="package-name">[`@stdlib/datasets-spam-assassin-cli`][@stdlib/datasets-spam-assassin-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/datasets-spam-assassin-cli]: https://www.npmjs.com/package/@stdlib/datasets-spam-assassin-cli
